...
public final class RaiosOtimos {

    private static final Map<Integer, Integer> VALORES = Map.ofEntries(
    ...
    public static int obter(int idInstancia) {
        return VALORES.get(idInstancia);
    }
}
